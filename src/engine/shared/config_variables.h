...
// patch
MACRO_CONFIG_INT(GfxScreenX, gfx_screen_x, 0, 0, 0, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Screen x position")
...
MACRO_CONFIG_INT(map_names, map_names, 0, 0, 0, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Map names")
// patch end
